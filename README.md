...
**IstagramApp** is a photo sharing app using Parse as its backend.
...
1. interfacing with camera
2. removing data from database through the app

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://i.imgur.com/mIFow7y.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
Passing data from view controller to view controller. Getting parse to recieve and retrieve data.
